...
SECRET_KEY = 'django-insecure-3c1!d=f7h--b0l!g0s6_7^mne#wmkuuz9)7+0vg_u23+!gy7^v'
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "House Hunting Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "House Hunting Admin",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "House Hunting Admin",
...
AUTH_USER_MODEL = 'house_hunting_app.User'
